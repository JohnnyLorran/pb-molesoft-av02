...
public class ConsoleColors {
    ...
    public void mensagemVermelha(String texto){System.out.println(ConsoleColors.RED + texto + ConsoleColors.WHITE + "\n");}

    public void padraoTexto(String mensagem){
        System.out.println(ConsoleColors.WHITE + mensagem);
    }

    public void respostaCorreta(){System.out.println(ConsoleColors.GREEN + "Muito bem, você acertou !" + ConsoleColors.WHITE);}

    public void respostaErrada(){System.out.println(ConsoleColors.RED + "Que pena, você errou." + ConsoleColors.WHITE);}

    public void semPlacar(){System.out.println(ConsoleColors.BLUE + "Ninguém completou o Quiz ainda, seja o primeiro. :)\n\n" + ConsoleColors.WHITE);}
